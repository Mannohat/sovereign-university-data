...
![Bitcoin's forhistorie](https://www.youtube.com/watch?v=ljHLhTzrLsw)
...
- Det tillader kommunikation mellem nutiden og fremtiden. Vi omdanner vores tid og energi til en aktiv, der kan genbruges i fremtiden uden risiko for værdiforringelse.
...
I dag er vi vidne til et historisk vendepunkt. Dollaren, der længe har domineret, synes at være i tilbagegang, og guld har mistet sin centrale plads. Vi befinder os ved skillevejen for en ny monetær cyklus, der minder os om, at historiens lektioner ofte bliver glemt.
...
Under hyperinflation taler vi ikke længere om 20% om året, men derimod 20% om måneden eller, på sit højdepunkt, om DAGEN. 100% inflation om dagen i 3 dage er et realistisk scenarie, der er sket og fortsat sker i vores verden.
...
Bitcoin's knaphed garanteres af to centrale mekanismer: justeringen af minedifficulty og spilteori:
...
### Hvad er netværkets anvendelsesområder?

Denne teknologi åbner døren for en bred vifte af potentielle anvendelser for Bitcoin, som tidligere var utilgængelige på grund af de nødvendige begrænsninger for at sikre sikkerheden og decentraliseringen af Bitcoin. Blandt disse anvendelser i hverdagen kan vi nævne øjeblikkelig fakturering i handel (både fysisk og online), streaming af penge til realtidsbetalinger og mikrodonationer til indhold. Ved at implementere et netværk af næsten øjeblikkelige, sikre og billige transaktioner (i gennemsnit mindre end 0,5%), kan mange tidligere utænkelige forretningsmodeller implementeres. Dette er muligt, fordi Lightning-netværket bruger sats (decimalen af bitcoin) til at fungere.

![image](assets/Concept/chapitre18/9.png)

Videospilindustrien tilbyder et særligt interessant eksempel på, hvordan Lightning-netværket kan bruges til at transformere eksisterende forretningsmodeller. Konceptet "skin in the game" er en idé, der for nylig er blevet populær i denne sammenhæng. Det indebærer i det væsentlige at have en økonomisk interesse i udfaldet af et spil.
Lightning-netværket giver spillere mulighed for at satse meget små beløb, når de spiller spil, f.eks. et par satoshis (omkring en brøkdel af en eurocent). Dette muliggør etablering af en indsats, der stimulerer konkurrence, samtidig med at omkostningerne ved at implementere bots øges markant.

![image](assets/Concept/chapitre18/2.png)

Samlet set ser fremtiden for mikrotransaktioner med Bitcoin lovende ud takket være innovationer som Lightning-netværket. Når disse teknologier fortsætter med at udvikle sig og modne, kan vi forvente at se nye og spændende anvendelser opstå i nær fremtid. Tag f.eks. konceptet "money streaming". Med Lightning-netværket kan vi foretage mikrotransaktioner hvert minut (potentielt uden en betroet tredjepart), hvilket åbner døren for eksperimenter med økonomiske modeller, hvor forbrugerne betaler for indhold baseret på, hvad de forbruger.

![image](assets/Concept/chapitre18/8.png)

I et sådant system deles penge automatisk, baseret på en foruddefineret procentdel, mellem de forskellige bidragsydere til en service eller et produkt. Dette kunne revolutionere måden, vi tænker på betalingsmodeller. For eksempel kunne brugerne i stedet for at betale et månedligt abonnement for en service blive opkrævet pr. minut eller endda pr. sekund for den tid, de bruger på at bruge servicen. En sådan økonomisk model kunne have dybtgående konsekvenser for indholdsproducenter, der ville have incitament til at producere kvalitetsindhold for at fastholde brugernes opmærksomhed. Brugerne ville til gengæld kun betale for det indhold, de forbruger, hvilket eliminerer forudbetalte abonnementsgebyrer. Det er endda tænkeligt at bruge dette system til at leje varer.

![image](assets/Concept/chapitre18/3.png)

Afslutningsvis åbner Lightning-netværket op for en mangfoldighed af spændende anvendelsesmuligheder for Bitcoin-brugere. De resulterende økonomiske modeller og forretningsmuligheder er talrige og varierede. Vi opfordrer dig til at prøve det af selv ved at prøve podcast-applikationen [Fountain](https://www.fountain.fm/), der giver dig mulighed for at blive belønnet med et par sats for at lytte til dine yndlingspodcasts!

## Rød pille eller blå pille?

![red pill](https://youtu.be/nCRVIoyyyck)

Som Morpheus sagde til Neo: "Du tager den blå pille, historien slutter, du vågner op i din seng, og du tror på, hvad du vil tro. Du tager den røde pille, du bliver i Eventyrland, og jeg viser dig, hvor dybt kaninhullet går." Er du klar til at udforske Bitcoin-kaninhullet? Vær forsigtig, da du måske genopdager din økonomiske frihed!
![rød pille](assets/posters/da/2_pilluleorange.png)
### Den teknologiske fremtid og dens konsekvenser

Teknologien udvikler sig eksponentielt, og ingen kan med sikkerhed forudsige dens fremtidige udvikling. Verdens forbindelse og kunstig intelligens fortsætter med at udvikle sig. Den viden, en person kan opnå gennem internettet, bliver stadig mere umålelig over tid.

Lad os tage AI som et eksempel. Disse teknologier har allerede overgået eller nærmer sig menneskelig præstation inden for en voksende række domæner, såsom videospil, billed- og tekstproduktion og dataanalyse. En potentiel konsekvens er, at over 80% af jobbene vil forsvinde på grund af AI og automatisering. Der er flere muligheder for os, såsom at begrænse teknologisk fremskridt eller udnytte den øgede kapital fra produktivitetsgevinster skabt af AI.

De væsentlige spørgsmål, der skal stilles, er:

- Hvordan håndterer vi et samfund, hvor 80% af jobbene vil forsvinde?
- Hvordan genoplivner vi en befolkning?
- Er der behov for så mange lærere?
- De geopolitiske, politiske og menneskelige konsekvenser af automatisering diskuteres ikke tilstrækkeligt.
  Computere, internettet, streaming og VR vil ændre uddannelse. Vi kunne have et universelt kursus for alle danske studerende, der administreres af regeringen og lærere, der ikke længere holder forelæsninger, men direkte følger eleverne. Børn kunne gå ind i en virtuel verden og blive fulgt i at lære historie.

- Hvor går grænsen mellem en lærer og en AI?
- Hvordan kan vi garantere et samfund, der lever i velstand?

Disse grundlæggende spørgsmål for vores fremtid skal debatteres og besluttes kollektivt. Men hvad er forbindelsen til Bitcoin? Ligesom internettet for kommunikationsformer er Bitcoin en teknologisk revolution for nye former for storstilet organisation, der giver os mulighed for at udveksle værdi uden nogen betroet tredjepart. Ønsker vi at hindre den teknologiske udvikling af det monetære system eller høste den øgede kapital gennem den ti-dobbelte produktivitetsgevinst ved brug af Bitcoin og Lightning-protokoller?

### Hvad er fremtiden for finans?

Disse overvejelser rejser også spørgsmål om, hvem der skal holde, godkende og spore de penge, vi bruger. Målet er at beslutte mellem et lukket system med ikke-valgte ledere eller et åbent system uden betroede tredjeparter, hvor neutralitet hersker.

- Er valuta en form for privat ejendom?
- Kan protesterendes konti blokeres uden en domstolskendelse?
- Hvem garanterer det finansielle system?
- Hvordan kan enkeltpersoner være suveræne over deres penge og stole på en betroet tredjepart?
- Kan penge sendes til den anden side af verden uden gebyrer eller mellemmænd?

Accept af disse nye teknologier kan generere massive stordriftsfordele globalt. Skal vi tillade fri bevægelighed af kapitalstrømme? Internationale blokader har økonomiske og politiske konsekvenser. Er det etisk at bruge finansielle mellemmænd som Western Union, der nogle gange opkræver op til 25% i gebyrer? Vi mener, at i en stadig mere digital verden bør penge demokratiseres og betragtes som et fælles gode, der tilhører folket snarere end staten eller uigennemsigtige finansielle institutioner.

Spørgsmålet om, hvem der skal kontrollere banksystemet, er afgørende, fordi reglerne for banksystemet ikke er gennemsigtige og forståelige for alle, hvilket giver en kaste af politikere og reguleringsmyndigheder mulighed for at opretholde deres greb om systemet. Det er vigtigt at spørge, om det frie marked eller en gruppe intellektuelle skal kontrollere banksystemet.

### Vores friheder er på spil.

Censuren skal også sættes spørgsmålstegn ved, for hvem har viden til at beslutte, hvad der skal censureres eller ej? Medierne har ændret deres holdning til visse oplysninger, og de mennesker, der tidligere blev censureret, bliver ikke længere censureret i dag.

- Hvem beslutter, hvad der er censur eller propaganda?
- Hvem har den guddommelige hånd over vores system?
At tolerere censur kan ødelægge ytringsfriheden og retten til forsamling. Implementering af censur er teknisk svært uden at skabe en komplet dystopi. Hvilken enhed skal have magten til at censurere? Spørgsmålet om censur er kompliceret, og det er svært at vide, hvem der skal censureres eller ej. Censur kan have en negativ indvirkning på innovation og frihed til at handle.

Der er 2,4 milliarder mennesker i verden uden en bankkonto, hvilket nødvendigvis skaber geografiske uligheder. Bitcoin muliggør lighed i transaktioner, uanset din sociale status eller politiske position. Bitcoin-protokollen er upolitisk og giver ikke specifikke privilegier til præsidenten eller andre aktører. Ledere bør have de samme privilegier som almindelige mennesker for at fremme udviklingen opad i stedet for at efterlade nogle øverst og andre nederst. Skulle alle have den samme valuta, uanset deres sociale status? Det er vigtigt at tænke på den verden, vi ønsker at efterlade til vores børn. Vi ønsker at efterlade en åben verden, hvor de er frie til at gøre, hvad de vil med deres penge.

Bitcoin er vigtig og bør ikke betragtes som bare et spil med chancer. Det er afgørende at fortsætte med at stille spørgsmål om Bitcoin.

### Bitcoin: en revolutionerende protokol

![Konklusion](https://youtu.be/BoZL_D7uLAg)

Som vi har set i det foregående kapitel, er Bitcoin-protokollen neutral over for alle dens brugere. Takket være konsensusregler og kryptografi kan vi uforanderligt registrere transaktioner i et globalt offentligt hovedbog, der garanterer overførsel af monetær værdi uden nogen betroet tredjepart. Infrastrukturen på andet niveau (og snart også tredje niveau med RGB) muliggør netværksskalering og udvikling af nye funktionaliteter, især til at håndtere skaleringsproblemer.

Bitcoin har alle de nødvendige karakteristika for at være en effektiv og sund valuta: opdelbar, øjeblikkeligt transportabel, umulig at censurere, ubetydelige omkostninger ved verifikation og med en monetær politik, der allerede er fastlagt for århundreder fremover med disse 21 millioner enheder. Bitcoin er pseudonymt og kan udveksles overalt i verden uden nogen autorisation fra nogen enhed, du skal bare have dine egne private nøgler - som ordsproget siger "Ikke dine nøgler, ikke dine bitcoins".

Bitcoin bliver adopteret af forskellige grupper af mennesker, lige fra kryptografer til libertarianske til traditionelle virksomheder og endda et land. Dog er Bitcoin for alle, og antallet af brugere vokser, ligesom antallet af Bitcoin-noder, der fungerer som vogtere af transaktionshistorikken og sikrer dens decentralisering.

Bitcoin kan ikke stoppes længere og kan ikke censureres længere. Det er en fredelig revolution for at ændre det monetære system og muliggøre økonomisk inklusion. Brugere kan opnå Bitcoins ved at acceptere dem som betaling eller ved at købe dem gennem regulerede eller uregulerede platforme. Bitcoins kan opbevares i tegnebøger, mobilapplikationer eller fysiske enheder. Der er ingen betroet mellemmand i Bitcoin, Bitcoin fremmer gennemsigtighed, frihed og individuelt ansvar - som ordsproget siger "Don't Trust, Verify".

At ændre det finansielle system kræver at ændre valutaen. Satoshi skabte Bitcoin i 2008 for at foreslå et forsøg på dette. Adgang til nemme og "magiske" penge korrumperer. Bitcoin er derfor et alternativ til at opbygge et nyt neutralt monetært system. Bitcoin muliggør frigørelse fra banksystemet. Det er et socialt fænomen, der fører os til at deltage i en fredelig revolution. Er du klar til at være med?

## Anerkendelser og fortsæt med at grave i kaninhullet

### Gå videre

![Anerkendelser og fortsæt med at grave i kaninhullet](https://youtu.be/A2P5GdkgB-M)

Tillykke med at have gennemført denne BTC 101-kursus! Jeg håber oprigtigt, at du har nydt det, og at det har åbnet døre for dig. Din opdagelse af bitcoin er kun lige begyndt, og jeg opfordrer dig til at udforske alle de andre kurser, der er tilgængelige på universitetet.
- [BTC 102](https://sovereignuniversity.org/course/btc102/fr) vil hjælpe dig med at oprette din bitcoin-plan.
- [LN 201](https://sovereignuniversity.org/course/ln201/fr) og [LN 202](https://sovereignuniversity.org/course/ln202/fr) vil give dig mulighed for at opdage Lightning Network, et betalingsnetværk på andet niveau.
- [ECON 201](https://sovereignuniversity.org/course/econ201/fr) vil dække østrigsk økonomi.
- [SECU 101](https://sovereignuniversity.org/course/secu101/fr) vil give dig mulighed for at opdatere din digitale sikkerhed.
- [MINAGE 201](https://sovereignuniversity.org/course/min201/fr) for at lære mere om minedrift.
- og mange flere...

## Støt os

Denne kursus, samt alt indholdet på dette universitet, er blevet tilbudt gratis af vores fællesskab. For at støtte os kan du dele det med andre, blive medlem af universitetet og endda bidrage til dets udvikling via [vores GitHub](https://github.com/DecouvreBitcoin/sovereign-university-data). På vegne af hele teamet, tak!

## Bemærk træningen

Et karaktergivningssystem for træningen vil snart blive integreret i denne nye E-learning-platform! I mellemtiden takker vi dig meget for at tage kurset, og hvis du nød det, bedes du overveje at dele det med andre.

En stor tak til vores Patreon-supportere, medlemmer og donorer for deres økonomiske støtte, tak til de mennesker, der deler, og tak til dem, der har gjort denne træning mulig: Rachel, Muriel, StackinSat-teamet, JohnOnChain, Fanis, Guillaume, Lounes, korrekturlæserne og anmelderne.
